                    ...
                    <div class="align-middle min-w-full  shadow overflow-hidden sm:rounded-lg">
                        <div class="my-4">
                            <a href="{{ route('breed-types.create') }}"
                               class="underline font-bold leading-6 text-md uppercase">Add the Breed Types</a>
                        </div>
                        <div class="my-4">
                            <a href="{{ route('breed-types.index') }}"
                               class="underline font-bold leading-6 text-md uppercase">View all Breed Types</a>
                        </div>
                        <form class="bg-white py-3 px-6"
                              wire:submit.prevent="updateBreedTypes">
                            <div>
                                <div class="mt-3 pt-2">
                                    <div>
