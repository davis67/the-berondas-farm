                                            ...
                                            @forelse($rabbits as $rabbit)
                                                <tr x-data
                                                    @click="
                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                console.log(target)
                                                                                                                                                                                                                                                                                                                                                                const ignores = ['button', 'svg', 'path', 'a', 'input'];
                                                                                                                                                                                                                                                                                                                                                                if(! ignores.includes(target))
                                                                                                                                                                                                                                                                                                                                                                  {
                                                                                                                                                                                                                                                                                                                                                                    $event.target.closest('.rabbit-row').querySelector('.view-rabbit').click()
                                                                                                                                                                                                                                                                                                                                                                  }
                                                                                                                                                                                                                                                                                                                                                                "
                                                    class="rabbit-row bg-white hover:bg-gray-100 cursor-pointer"
                                                    ...
                                                    <x-table.cell>
                                                        <div class="flex">
                                                            <x-button.href class="view-rabbit text-sm"
                                                                           href="{{ route('breed-types.index') }}">
