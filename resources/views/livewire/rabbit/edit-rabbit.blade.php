@section('title', 'Edit Rabbit')
@section('header', 'Edit Rabbit')
<div class="mt-2">
    <!-- Add Batch Form -->
    <div class="block">
        <div class="mx-auto text-lg leading-6 font-medium text-cool-gray-900">
            <div class="flex flex-col mt-2">
                <div class="align-middle min-w-full  shadow overflow-hidden sm:rounded-lg">
                    <form class="bg-white py-3 px-6" wire:submit.prevent="updateRabbit">
                        <div>
                            <div class="mt-3 pt-2">
                                <div>
                                ...
                                <div class="sm:col-span-4">
                                    <label for="rabbit_no" class="block text-sm font-medium leading-5 text-gray-700">
                                        Rabbit No
                                    </label>
                                    <div class="mt-1 rounded-md shadow-sm">
                                        <input id="rabbit_no" type="text" wire:model.lazy="rabbit_no" class="form-input block w-full rounded-none border transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('rabbit_no') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" />
                                        @error('rabbit_no')
