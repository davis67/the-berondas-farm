    ...
    <div class="block">
      <div class="mx-auto text-lg leading-6 font-medium text-cool-gray-900">
        ...
        <div class="bg-white shadow my-2 overflow-hidden sm:rounded-md">
          <ul>
            <li>
              <a href="{{route('breed-types.edit', $breed_type->id)}}" class="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
                      ...
                      <div class="hidden md:block">
                        <div>
                          <div class="text-sm leading-5 text-gray-900">
                            Added on
                            <time datetime="2020-01-07">{{$breed_type->created_at}}</time>
                          </div>
                        </div>
                      </div>
                    </div>
