@section('title', 'View Rabbits')
    <div class="">
        @include('livewire.logs.partials.summary')
        <div class="block">
                    ...
                    <div class="align-middle min-w-full  shadow overflow-hidden sm:rounded-lg">
                        <div class="bg-white border border-cool-gray-200  sm:px-6 lg:px-8">
                            ...
                            <div class="bg-white flex flex-col mt-2">
                                @include('livewire.logs.partials.table')
            ...
            @if ($showDetailsScreen)
                @include('livewire.logs.partials.details-slideover')
            @endif

            <form wire:submit.prevent="save">
                @include('livewire.logs.partials.add-rabbit-modal')
            </form>

            <!-- Add Rabbit Confirmation Modal -->
            @if ($confirmingLogDeletion === true)
        ...
        <form wire:submit.prevent="deleteSelected">
            @include('livewire.logs.partials.delete-rabbit-modal')
        </form>
