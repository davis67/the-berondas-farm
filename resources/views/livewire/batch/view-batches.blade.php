    ...
    <div class="mx-auto text-lg leading-6 font-medium text-cool-gray-900">
      <div class="flex flex-col mt-2">
        ...
        <div class="grid lg:grid-cols-3 grid-cols-1  gap-4">
          ...
          <div class="border border-1 py-4 px-4 flex items-center bg-white shadow-sm h-32 my-2 overflow-hidden rounded-none">
            <a href="{{route('batches.show', $batch->id)}}" class="w-full">
              <div class="flex w-full items-center">
                <div class="space-y-2">
                  <div><span>{{$batch->batch_no}}</span></div>
                  <div><span>{{$batch->number_of_cages}} Compartments</span></div>
