     ...
     <div class="mt-1 space-y-4">
                     ...
                     <div class="p-5">
                         <div class="flex items-center">
                             <div class="flex-shrink-0">
                                 <svg class="h-6 w-6 text-cool-gray-400"
                                      fill="none"
                                      viewBox="0 0 24 24"
                                      stroke="currentColor">
         ...
         <div class="my-4">
             <a href="{{ route('expense-types.index') }}"
                class="underline font-bold leading-6 text-md uppercase">View all Expense Types</a>
         </div>
                     ...
                     <div class="bg-white p-4 rounded shadow flex relative">
                         ...
                         <div class="w-1/2 pl-2 space-y-4">
                             ...
                             <x-input.group inline
                                            ...
                                            label="Maximum Date">
                                 <x-input.date type="date"
                                               wire:model.lazy="date_max"
                                               id="date_max"
                                               placeholder="MM/DD/YYYY" />
                             </x-input.group>

                             <x-button.link wire:click="resetFilters"
                                            class="absolute right-0 bottom-0 p-4">Reset Filters</x-button.link>
                         </div>
                     </div>
                 @endif
             </div>
                 ...
                 <x-table>
                     <x-slot name="head">
                         <x-table.header sortable
                                         wire:click="sortBy('expense_type_id')"
                             ...
                             <x-table.row wire:loading.class="opacity-50">
                                 ...
                                 <x-table.cell>
                                     <a href="{{ route('expenses.edit', $expense->id) }}"
                                        class="underline font-bold leading-6 text-md uppercase">Edit Expense</a>
                                 </x-table.cell>
                             </x-table.row>
                         @empty
                             <x-table.row>
