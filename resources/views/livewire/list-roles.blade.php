                    ...
                    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between my-6">
                            ...
                            <div class="text-right mr-12">
                                <x-button.href href="{{ url('/settings/roles/new') }}" class="border border-teal-600 px-2 py-2 rounded-md">{{ trans('settings.role_create') }}</x-button.href>
                            </div>
                        </div>
                        ...
                        <table class="w-full min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($roles as $role)
                                    <tr class="">
                                        <td class="text-left px-6 py-4 whitespace-nowrap"><a href="{{ url("/settings/roles/{$role->id}") }}">{{ $role->display_name }}</a></td>
