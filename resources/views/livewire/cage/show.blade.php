    ...
    <div class="mt-2">
            ...
            <div class="mx-auto text-lg leading-6 font-medium text-cool-gray-900">
                <div class="flex flex-col mt-2">
                    <div>
                        ...
                        <div class="my-4">
                            <a href=""
                               class="underline font-bold leading-6 text-md uppercase">Edit this Cage Type</a>
                        </div>
                        <form class="bg-white py-3 px-6 w-full"
                              wire:submit.prevent="handleTransfer">
                            <div>
                                <div class="mt-3 pt-2">
                                    <div>
                                    ...
                                    <div class="mt-4 flex space-x-4 justify-between">
                                        <div class="flex-1">
                                            ...
                                            <div class="mt-1 rounded-md shadow-sm">
                                                <select id="rabbit"
                                                        wire:model.lazy="rabbit"
                                                        class="form-input block w-full rounded-none border transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('rabbit') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror">
                            ...
                            <div class="mt-8 border-t border-gray-200 pt-5">
                                <div class="flex justify-end">
                                    ...
                                    <span class="ml-3 inline-flex rounded-md shadow-sm">
                                        <x-primary-button wire:click="validateTransfer"
                                                          wire:loading.attr="disabled">
                                ...
                                <div x-data="{ tooltip: false }"
                                    ...
                                    <div class="relative"
                                        ...
                                        <div class="absolute top-0 z-10 w-64 p-2 -mt-1 text-sm leading-tight transform -translate-x-1/2 -translate-y-full bg-teal-50 rounded-none border border-gray-50 shadow-lg">
                                            ...
                                            @if ($rabbit->breed)
                                                <div class="text-gray-500 uppercase">BREED: {{ $rabbit->breed }}</div>
                                            @endif
                                        </div>
                                        <svg class="absolute z-10 w-6 h-6 text-gray-50 transform -translate-x-12 -translate-y-3 fill-current stroke-current"
                                             width="8"
                                             height="8">
                                            <rect x="12"
                                                  y="-10"
        ...
        @if ($confirmingRabbitTransfer === true)
            <x-confirmation-modal>
                ...
                <x-slot name="footer">
                    <x-secondary-button wire:click="$toggle('confirmingRabbitTransfer')"
                                        wire:loading.attr="disabled">
                        Nevermind
                    </x-secondary-button>

                    <x-danger-button class="ml-2"
                                     wire:click="handleTransfer"
                                     wire:loading.attr="disabled">
                        Confirm Transfer
                    </x-danger-button>
                </x-slot>
