  ...
  <nav x-data="{ open: false }" class="bg-white shadow-sm">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex">
            <a href="{{route('home')}}" class="inline-flex items-center px-1 pt-1 {{ Nav::isRoute('home') }}  text-sm font-medium leading-5 focus:outline-none focus:border-teal-700 text-gray-500 transition duration-150 ease-in-out">
              Home
            </a>
            ...
            <a href="{{route('rabbits.index')}}" class="ml-8 inline-flex items-center {{ Nav::isRoute('rabbits.create') }} {{ Nav::isRoute('rabbits.index') }} px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
              Rabbits
            </a>
    ...
    <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
      <div class="pt-2 pb-3">
        ...
        <a href="{{route('batches.index')}}" class="mt-1 block {{ Nav::isRoute('batches.index', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} {{ Nav::isRoute('batches.create', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">Batches</a>
        <a href="{{route('farms.index')}}" class="mt-1 {{ Nav::isRoute('farm.create', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} block pl-3 pr-4 py-2 border-l-4 {{ Nav::isRoute('farms.index', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">Farms</a>
        <a href="{{route('expenses.index')}}" class="mt-1 {{ Nav::isRoute('expenses.create', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} {{ Nav::isRoute('expenses.index', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">Expenses</a>
        <a href="{{route('rabbits.index')}}" class="mt-1 {{ Nav::isRoute('rabbits.create', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} {{ Nav::isRoute('rabbits.index', $activeClass = 'border-l-4 text-teal-700 border-teal-500 bg-teal-50 ') }} block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">Rabbits</a>
